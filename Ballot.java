...
public class Ballot extends JFrame
{
    ...
    tokens = new String[ballots.size()][ballots.get(0).length];
	      ...
	      //just a blank line
	        ...
	        MainWindow main = new MainWindow(numberOfBallots, ballotRows);
	...
	public Ballot(int tempInt)
	{
		...
		int voterID = tempInt;
		new MainWindow(getNumberOfBallots(),getBallotRows(),voterID, getballotID(),candidate );
	}
	private void setBallotRows(int longestRow)
	{
		ballotRows = longestRow;
	}
	private int getBallotRows()
	{
		return ballotRows;
	}
